...
class Dispatchers(Base):
    ...
    # Add the missing relationship - this corresponds to Load.dispatcher
...
class Load(Base):
    ...
    pickup_facility_id = Column(Integer, ForeignKey("facilities.id"))
    dropoff_facility_id = Column(Integer, ForeignKey("facilities.id"))
...
class Leg(Base):
    ...
    pickup_facility_id = Column(String(255))
    dropoff_facility_id = Column(String(255))
    pickup_address = Column(String(255))
    dropoff_address = Column(String(255))
